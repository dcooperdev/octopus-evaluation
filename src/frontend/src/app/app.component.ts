...
export class AppComponent implements OnInit {
  ...
  constructor( private jwt: JwtHelperService,
               private store: Store<AppState> ) {
                 // Persistir el estado de la lista de publicaciones

                 store.subscribe(( state: AppState ) => localStorage.setItem('publications', JSON.stringify(state.blog.publications)) );
               }
